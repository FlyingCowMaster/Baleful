...
import static balefulmod.BalefulMod.characterPath;
import static balefulmod.BalefulMod.makeID;

public class Baleful extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("Baleful"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass BALEFUL;
        @SpireEnum(name = "ORANGE") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "ORANGE") @SuppressWarnings("unused")
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new Baleful(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
